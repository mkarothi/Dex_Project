...
<!-- 
 ...
 -->
	...
	if(isset($this->request->params['pass'][0]) && $this->request->params['pass'][0] != "nasusers" && $this->request->params['action'] == 'serverinventory') { ?>
        ...
        <div class="bulksearch-link-double"><a href="/reports/<?php echo $fromTable; ?>/<?php echo $this->request->params['action'];?>/bulkapp" class="bulksearch-link">Bulk Apps Search</a></div>
		</div>
    <?php } ?> 
