...
<table xmlns:rsext="xalan://com.cognos.reportserver.ext.RSExt" cellpadding="0" cellspacing="0" border="0" class="pg" LID="Page1"><tr class="tableRow"><td style="padding-bottom:10px;" class="ph"><div class="ta"><span tabIndex="0" class="tt">Capacity Utilization Report: VMAX 268_770 FE-1</span></div></td></tr><tr class="tableRow"><td class="pb"><div class="block"></div><div class="block"><span tabIndex="0" style="font-family:&quot;Arial Black&quot;;font-weight:bold;" class="textItem">Array Summary</span></div><div style="height:8mm;" class="block"><div class="block"><span tabIndex="0" style="padding:10px 18px 10px 18px;" class="textItem">No Data Available</span></div><div class="block"></div><div class="block"><span tabIndex="0" class="textItem"></span></div><span tabIndex="0" style="font-family:&quot;Arial Black&quot;;font-weight:bold;" class="textItem">Volume Details</span></div><div style="height:8mm;" class="block"><div class="block"><span tabIndex="0" style="padding:10px 18px 10px 18px;" class="textItem">No Data Available</span></div></div></td></tr><tr class="tableRow"><td style="padding-top:10px;" class="pf"></td></tr></table><script xmlns:rsext="xalan://com.cognos.reportserver.ext.RSExt" type="text/javascript">            
    var userAgent = navigator.userAgent.toLowerCase();          
    if ( (userAgent.indexOf("mozilla") > -1 && userAgent.indexOf ("msie") < 0)
        || (userAgent.indexOf("firefox") > -1))
    {
