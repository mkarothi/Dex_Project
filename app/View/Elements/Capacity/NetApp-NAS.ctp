...
<table xmlns:rsext="xalan://com.cognos.reportserver.ext.RSExt" cellpadding="0" cellspacing="0" border="0" class="pg" LID="Page1"><tr class="tableRow"><td style="padding-bottom:10px;" class="ph"><div class="ta"><span tabIndex="0" class="tt">NetApp (NAS) &nbsp;Storage Allocation</span></div></td></tr><tr class="tableRow"><td class="pb"><table style="border-collapse:collapse;width:100%;" class="tb" cellpadding="0"><tr class="tableRow"><td class="tableCell"></td><td class="tableCell"><span tabIndex="0"><img name="chartN0F6F2300.08281410" style="padding-left: 0px;padding-top: 0px;padding-right: 0px;padding-bottom: 0px;" class="ch" LID="Combination Chart1" src="/images/Capacity/NetApp-NAS.png" width="500" height="350"></span></td><td class="tableCell"></td></tr><tr class="tableRow"><td class="tableCell"></td><td class="tableCell"></td><td class="tableCell"></td></tr><tr class="tableRow"><td class="tableCell"></td><td class="tableCell"><div class="block"><span tabIndex="0" style="padding:10px 18px 10px 18px;" class="textItem">No Data Available</span></div></td><td class="tableCell"></td></tr></table></td></tr><tr class="tableRow"><td style="padding-top:10px;" class="pf"></td></tr></table><script xmlns:rsext="xalan://com.cognos.reportserver.ext.RSExt" type="text/javascript">         
    var userAgent = navigator.userAgent.toLowerCase();          
    if ( (userAgent.indexOf("mozilla") > -1 && userAgent.indexOf ("msie") < 0)
        || (userAgent.indexOf("firefox") > -1))
    {
