...
<table xmlns:rsext="xalan://com.cognos.reportserver.ext.RSExt" cellpadding="0" cellspacing="0" border="0" class="pg" LID="Page1"><tr class="tableRow"><td style="padding-bottom:10px;" class="ph"><div class="ta"><span tabIndex="0" class="tt">NAS- High Level Capacity Report</span></div></td></tr><tr class="tableRow"><td class="pb"><table style="border-collapse:collapse;width:100%;" class="tb" cellpadding="0"><tr class="tableRow"><td class="tableCell"><map class="chart_map" LID="rsvptt0" name="rsvptt0"><area class="chart_area" type="legendLabel" shape="POLY" coords="255, -3, 357, -3, 357, 11, 255, 11" title="Allocated_Capacity(TB)" tabIndex="-1"><area class="chart_area" type="legendLabel" shape="POLY" coords="255, 12, 360, 12, 360, 25, 255, 25" title="Used_Capacity(TB)" tabIndex="-1"><area class="chart_area" type="legendLabel" shape="POLY" coords="255, 26, 360, 26, 360, 39, 255, 39" title="Available_Capacity(TB)" tabIndex="-1"><area class="chart_area" type="ordinalAxisTitle" shape="POLY" coords="103, 364, 126, 364, 126, 377, 103, 377" title="NAS" tabIndex="-1"><area class="chart_area" type="ordinalAxisLabel" shape="POLY" coords="11, 285, 214, 285, 214, 377, 11, 377" title="System = NAS" tabIndex="-1"><area class="chart_area" type="chartElement" shape="POLY" coords="112, 178, 216, 178, 215, 168, 214, 159, 212, 151, 209, 142, 206, 134, 202, 126, 197, 118, 191, 111, 185, 104, 178, 98, 171, 92, 164, 87, 155, 83, 147, 80, 138, 77, 130, 75, 121, 74, 112, 74, 102, 74, 93, 75, 85, 77, 76, 80, 68, 83, 60, 87, 52, 92, 45, 98, 38, 104, 32, 111, 26, 118, 21, 125, 17, 134, 14, 142, 11, 151, 9, 159, 8, 168, 8, 177, 8, 187, 9, 196, 11, 204, 14, 213, 17, 221, 21, 229, 26, 237, 32, 244, 38, 251, 45, 257, 52, 263, 59, 268, 68, 272, 76, 275, 85, 278, 93, 280, 102, 281, 111, 282, 121, 281, 130, 280, 138, 278, 147, 275, 155, 272, 163, 268, 171, 263, 178, 257, 185, 251, 191, 244, 197, 237, 202, 230, 206, 221, 209, 213, 212, 204, 214, 196, 215, 187, 216, 178" title="System = NAS &#10;NaN" tabIndex="-1"></map><span tabIndex="0"><img name="chartN0F6F3B80.1055EF18" style="width:10cm;height:10cm;padding-left: 0px;padding-top: 0px;padding-right: 0px;padding-bottom: 0px;" class="ch" LID="Pie Chart1" src="/images/Capacity/NAS.png" width="378" height="378" usemap="#rsvptt0" border="0"></span></td></tr><tr class="tableRow"><td class="tableCell"></td></tr><tr class="tableRow"><td class="tableCell"></td></tr></table><table style="border-collapse:collapse;" class="ls" LID="List1" cellpadding="0"><tr><td class="lt"><span tabIndex="0" class="textItem">System</span></td><td class="lt"><span tabIndex="-1" class="textItem">Allocated_Capacity(TB)</span></td><td class="lt"><span tabIndex="-1" class="textItem">Used_Capacity(TB)</span></td><td class="lt"><span tabIndex="-1" class="textItem">Available_Capacity(TB)</span></td></tr><tr><td class="lm"><span tabIndex="-1" class="textItem">NAS</span></td><td class="lm"><span tabIndex="-1" class="textItem"></span></td><td class="lm"><span tabIndex="-1" class="textItem"></span></td><td class="lm"><span tabIndex="-1" class="textItem"></span></td></tr></table></td></tr><tr class="tableRow"><td style="padding-top:10px;" class="pf"></td></tr></table><script xmlns:rsext="xalan://com.cognos.reportserver.ext.RSExt" type="text/javascript">         
    var userAgent = navigator.userAgent.toLowerCase();          
    if ( (userAgent.indexOf("mozilla") > -1 && userAgent.indexOf ("msie") < 0)
        || (userAgent.indexOf("firefox") > -1))
    {
