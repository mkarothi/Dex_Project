...
<div id="left_side">
    ...
    <div class="gadget">
        <ul class="sb_menu">
            ...
            <li>
                <a href="/reports/CMDB/serverinventory" <?php if(isset($this->request->params['pass'][0]) && $this->request->params['pass'][0] == "CMDB") {?>class = "sidebar-selected" <?php } ?> >ADDM Server Search</a>
            </li>
            <li>
                <a href="/reports/RVTools/serverinventory" <?php if(isset($this->request->params['pass'][0]) && $this->request->params['pass'][0] == "RVTools") {?>class = "sidebar-selected" <?php } ?> >Foreman Server Search</a>
            </li>
            <li>
                <a href="/reports/HMCScans/serverinventory" <?php if(isset($this->request->params['pass'][0]) && $this->request->params['pass'][0] == "HMCScans") {?>class = "sidebar-selected" <?php } ?> >Cloud Server Search</a>
            </li> 
            <li>
            ...
            <!-- NSLookup & Ping Check C://Portal-Scripts/PingCheck_DNSLookup/PingCheck_DNSLookup.pl  -->           
        </ul>
        <ul class="ns-lookup-link">
            <li></li>
        </ul>
...
<div id="left_side">
    ...
    <div class="gadget">
        <ul class="sb_menu">
            <li>
                <a href="/reports/global/sanstorage" <?php if(isset($this->request->params['pass'][0]) && $this->request->params['pass'][0] == "global") {?>class = "sidebar-selected" <?php } ?> >Global SAN Data Search</a>
            </li>
            <li>
                <a href="/reports/storagehosts/sanstorage" <?php if(isset($this->request->params['pass'][0]) && $this->request->params['pass'][0] == "storagehosts") {?>class = "sidebar-selected" <?php } ?> >Server Storage Search</a>
            </li>
            <li>
                <a href="/reports/symdevice/sanstorage" <?php if(isset($this->request->params['pass'][0]) && $this->request->params['pass'][0] == "symdevice") {?>class = "sidebar-selected" <?php } ?> >Sym Device Search</a>
            </li>
            <li>
                <a href="/reports/symconfig/sanstorage" <?php if(isset($this->request->params['pass'][0]) && $this->request->params['pass'][0] == "symconfig") {?>class = "sidebar-selected" <?php } ?> >Sym Config Search</a>
            </li>
            <li>
                <a href="/reports/symrdf/sanstorage" <?php if(isset($this->request->params['pass'][0]) && $this->request->params['pass'][0] == "symrdf") {?>class = "sidebar-selected" <?php } ?> >Sym RDF Search</a>
            </li>
            <li>
                <a href="/reports/symclone/sanstorage" <?php if(isset($this->request->params['pass'][0]) && $this->request->params['pass'][0] == "symclone") {?>class = "sidebar-selected" <?php } ?> >Sym Clone Search</a>
            </li>
            <li>
                <a href="/reports/symbcv/sanstorage" <?php if(isset($this->request->params['pass'][0]) && $this->request->params['pass'][0] == "symbcv") {?>class = "sidebar-selected" <?php } ?> >Sym BCV Search</a>
            </li>
            <li>
                <a href="/reports/wwninitiator/sanstorage" <?php if(isset($this->request->params['pass'][0]) && $this->request->params['pass'][0] == "wwninitiator") {?>class = "sidebar-selected" <?php } ?> >WWN - Initiator Group Search</a>
            </li>
            <li><!-- /reports/storagegroup/sanstorage -->
                <a href="#" class = "<?php if(isset($this->request->params['pass'][0]) && $this->request->params['pass'][0] == "storagegroup") {?>sidebar-selected<?php } ?> red-text" >Storage Group Search</a>
            </li>              
            <li><!-- /reports/symlogin/sanstorage -->
                <a href="#" class = "<?php if(isset($this->request->params['pass'][0]) && $this->request->params['pass'][0] == "symlogin") {?>sidebar-selected<?php } ?> red-text">Sym Login Search</a>
            </li>
        </ul>
    </div>
</div>
