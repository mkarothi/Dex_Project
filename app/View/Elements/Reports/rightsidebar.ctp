...
<div id="right_side">
    ...
    <ul>
       <li class='has-sub'><a href='#'><span>Export Reports</span></a>
          <ul>
            <li>
                <a href="/reports/cmdb/exportsheet/">ADDM Server Data File</a>
            </li>
            <li>
                <a href="/reports/rvtools/exportsheet">Foreman ServerData File</a>
            </li>
            <li class='last'>
                <a href="/reports/hmcscans/exportsheet">Cloud Server Data File</a>
            </li>            
        </ul>
        </li>
        </ul>
